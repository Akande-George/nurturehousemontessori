...
const progressDataMap: Record<string, DemoProgress> = {
  ...
  emma: {
    ...
    teacherComments:
      "Emma is an exemplary learner in the Primary environment. She demonstrates intellectual curiosity, independence, and the ability to extend her own work into deeper explorations. Her mathematics progression is particularly strong — she self-corrects and seeks new challenges naturally.",
    teacherName: "Ms. Sarah Reed",
    recommendations: [
      {
...
let state: DemoState = {
  ...
  notices: [
    ...
    },
    {
      ...
      content:
        "We are pleased to invite all families to the Nurture House end-of-term concert on Friday 30th May at 3:00 PM. Children in the Primary and Elementary programmes will perform. Dress code is school uniform. Seats are limited — please confirm attendance by 20th May.",
      audience: "all-parents",
    ...
    },
    {
      ...
      content:
        "New materials have been added to the resource library this month including a guide on Montessori-friendly home environments, age-appropriate chores, and the mathematics progression for Primary children.",
      audience: "all-parents",
  ...
  invoices: [
    {
      ...
      description: "May 2026 Tuition — Toddler Programme",
    ...
    },
    {
      ...
      studentId: "zoe",
      parentId: "user-parent",
      description: "April 2026 Tuition — Toddler Programme",
      amountCents: 14500000,
    ...
    },
    {
      ...
      studentId: "emma",
      parentId: "user-parent",
      description: "May 2026 Tuition — Primary Programme",
    ...
    },
    {
      ...
      studentId: "emma",
      parentId: "user-parent",
      description: "April 2026 Tuition — Primary Programme",
      amountCents: 17500000,
      issuedAt: "2026-04-02T09:00:00.000Z",
      dueDate: "2026-04-10",
      status: "paid",
    ...
    },
    {
      ...
      studentId: "aisha",
      parentId: "user-parent-aisha",
      description: "May 2026 Tuition — Elementary Programme",

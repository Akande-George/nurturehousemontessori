          ...
          >
            <CardContent className="p-5">
              <div className="flex items-start gap-3">
                <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${i === 0 ? 'bg-montessori-primary/10' : 'bg-slate-100'}`}>
                  <Bell className={`w-4 h-4 ${i === 0 ? 'text-montessori-primary' : 'text-slate-400'}`} />
                </div>
